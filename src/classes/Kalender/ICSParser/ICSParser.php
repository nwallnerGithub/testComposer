...
namespace classes\SHARED\Kalender\ICSParser;
...
class ICSParser
{
    ...
    public function parseICSByURL( $url){
        if (!$url) {
            return false;
        }
        ...
        if (stristr($lines[0], 'BEGIN:VCALENDAR') === false) {
            ...
            $this->parseICSLines( $lines);
        }
    }

    public function parseICSByArray( $kalenderDateiAlsArray){
        $this->parseICSLines( $kalenderDateiAlsArray);
    }

    private function parseICSLines( $lines)
    {
